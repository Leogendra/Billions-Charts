...
const KEY_FEATURES_TEMPLATE = [
    "There are {two_billion_count} songs that have been streamed over 2 billion times, that's %{two_billion_percentage}% of all Billions songs 🎵",
    ...
    "Want to listen to every single one of these songs? Well, you'd need {total_time} hours. With each track averaging {average_track_length} minutes, hope you're ready for a marathon! 🕒",
    ...
    "{{longest_artist}} has the longest song with {{longest_song}}, running for {longest_duration} 🥵",
